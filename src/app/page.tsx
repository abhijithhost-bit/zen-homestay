            ...
            <div className="pb-8 border-b border-slate-200">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-[#4285F4] text-white font-bold flex items-center justify-center text-sm shrink-0">RK</div>
                      <div>
                        <p className="font-bold text-sm text-slate-900 leading-tight">Rahul Kumar</p>
                ...
                <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-[#EA4335] text-white font-bold flex items-center justify-center text-sm shrink-0">EM</div>
                      <div>
                        <p className="font-bold text-sm text-slate-900 leading-tight">Elena Martins</p>
                ...
                <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-[#34A853] text-white font-bold flex items-center justify-center text-sm shrink-0">PS</div>
                      <div>
                        <p className="font-bold text-sm text-slate-900 leading-tight">Priya Sharma</p>
                ...
                <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-bold text-sm text-slate-900 leading-tight">Vikram Nair</p>
                        <p className="text-[11px] text-slate-400 font-medium">1 month ago</p>
                      </div>
                    </div>
                    <svg className="w-4 h-4 shrink-0 mt-0.5" viewBox="0 0 24 24"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l3.66-2.84z" fill="#FBBC05"/><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/></svg>
                ...
                <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-[#4285F4] text-white font-bold flex items-center justify-center text-sm shrink-0">AT</div>
                      <div>
                        <p className="font-bold text-sm text-slate-900 leading-tight">Ananya Thomas</p>
                ...
                <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-[#EA4335] text-white font-bold flex items-center justify-center text-sm shrink-0">MJ</div>
                      <div>
                        <p className="font-bold text-sm text-slate-900 leading-tight">Michael Jensen</p>
                        <p className="text-[11px] text-slate-400 font-medium">2 months ago</p>
                      </div>
                    </div>
                    <svg className="w-4 h-4 shrink-0 mt-0.5" viewBox="0 0 24 24"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l3.66-2.84z" fill="#FBBC05"/><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/></svg>
                  ...
                  <p className="text-xs sm:text-sm text-slate-700 leading-relaxed">Traveled from Europe to experience Kerala&apos;s backwaters — this <strong>alleppey homestay on Punnamada Lake</strong> was the highlight of my entire India trip. The authentic food, the silence, the lake... absolutely spectacular.</p>
                </div>
