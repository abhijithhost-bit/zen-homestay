    ...
    <>
      ...
      <div className="md:hidden relative mb-6">
        ...
        <div className="flex items-center justify-between mt-2.5 px-1">
          ...
          >
            <Images className="w-3.5 h-3.5" /> {mobileSlideIdx + 1} / {images.length} &middot; View all
          </button>
        </div>
      </div>
      ...
      <div className="hidden md:grid grid-cols-4 gap-2.5 rounded-3xl overflow-hidden mb-12 relative shadow-md h-[520px] bg-slate-200">
        ...
        >
          <Images className="w-4 h-4" /> Show all 5 photos
        </button>
      </div>
      ...
      {showGallery && (
        <div className="fixed inset-0 z-[100] bg-slate-950/98 flex flex-col">
          ...
          <div className="flex items-center justify-between p-4 sm:p-5 border-b border-slate-800/60 shrink-0">
            ...
            <div className="text-slate-500 text-xs hidden sm:block">Esc to close &nbsp;&middot;&nbsp; &#8592; &#8594; to navigate</div>
          ...
          <div className="flex-1 flex flex-col min-h-0">
            ...
            <div className="flex-1 flex items-center justify-center min-h-0 px-4 sm:px-8 py-3">
              <div className="relative w-full">
                {/* Viewport-height container — fills screen on both mobile and desktop */}
                <div className="relative w-full h-[55vh] sm:h-[70vh] rounded-xl overflow-hidden shadow-2xl">
                  <Image
