        ...
        >
          ...
          <Link href="/" className="flex items-center gap-2.5 sm:gap-3 group shrink min-w-0">
            <div className="relative shrink-0">
              ...
              <span
                ...
                style={scrolled
                  ? { width: '8px', height: '8px', borderColor: 'white' }
            ...
            <div className="flex flex-col min-w-0">
              <span
                ...
                style={scrolled ? { color: 'rgb(15,23,42)', fontSize: '15px' } : { color: 'rgb(15,23,42)', fontSize: '19px' }}
              >
                Zen Homestay
              </span>
              <span
                ...
                style={scrolled
                  ? { color: 'rgb(2,132,199)', fontSize: '9px', marginTop: '1px' }
            ...
            {[
              ...
              <a
                ...
                onMouseEnter={e => {
                  ...
                  (e.currentTarget as HTMLElement).style.color = 'rgb(15,23,42)';
                }}
                onMouseLeave={e => {
          ...
          <div className="flex items-center gap-2 sm:gap-2.5 shrink-0">
            ...
            <a
              ...
              style={{ background: 'rgb(240,253,244)', color: 'rgb(6,78,59)', border: '1px solid rgba(187,247,208,0.8)', boxShadow: '0 1px 4px rgba(0,0,0,0.06)' }}
            >
              <MessageCircle
                className="w-4 h-4"
            ...
            <a
              ...
              style={{ background: 'rgb(240,253,244)', border: '1px solid rgba(187,247,208,0.8)' }}
            >
              <MessageCircle
                className="w-4 h-4"
                style={{ color: 'rgb(22,163,74)' }}
